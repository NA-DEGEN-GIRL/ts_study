 ...
 *
 * 이 파일에서 배울 내용:
 * - 제네릭 (Generic) - 타입을 매개변수로 받는 함수나 클래스
 * - 타입 매개변수 (Type Parameter) <T> - 재사용 가능한 타입 변수
 * - 타입 추론 (Type Inference) - 제네릭 타입 자동 결정
 * - 다중 타입 매개변수 <T, U> - 여러 개의 제네릭 타입 사용
 * 왜 필요한가? 타입 안정성을 유지하면서 다양한 타입에 대응 가능
 */

console.log("=== 제네릭 함수 (Generic Functions) ===\n");

// ============================================
// 1. 기본 제네릭 (Generic) 함수 - 타입을 변수처럼 사용
// ============================================

console.log("--- 1. 기본 제네릭 함수 ---\n");
// 왜 필요한가? 타입마다 함수를 중복 작성하지 않고 하나로 처리
