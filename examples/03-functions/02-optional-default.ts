 ...
 *
 * 이 파일에서 배울 내용:
 * - 선택적 매개변수 (Optional Parameter) - ? 기호로 생략 가능한 매개변수
 * - 기본 매개변수 (Default Parameter) - 값이 없을 때 사용할 기본값 지정
 * - 나머지 매개변수 (Rest Parameter) - ...으로 여러 인자를 배열로 받기
 * - 구조 분해 (Destructuring)와 기본값 조합
 * 왜 필요한가? 함수를 유연하게 호출할 수 있어 사용성 향상
 */
