...
// 해설: number 타입은 정수와 실수 모두 포함합니다
const age: number = 25;

// 해설: boolean 타입은 true 또는 false만 가능합니다
const isStudent: boolean = true;

// 연습 2: 타입이 지정된 함수를 작성하세요
// 해설: 매개변수에 타입을 명시하고, 함수 괄호 뒤에 반환 타입을 명시합니다
function add(a: number, b: number): number {
  return a + b;
}

// 연습 3: 타입 에러를 수정하세요
// 해설: person 매개변수에 string 타입을 명시해야 합니다
...
// 연습 4: 배열 타입을 사용하세요
// 해설: number[] 또는 Array<number> 형식으로 배열 타입을 명시합니다
const numbers: number[] = [1, 2, 3, 4, 5];

// 연습 5: 객체 타입을 정의하세요
// 해설: type 키워드로 객체의 구조를 정의합니다
type User = {
  name: string;
  age: number;
};
